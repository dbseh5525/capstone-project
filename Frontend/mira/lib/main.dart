          ...
          builder: (context, careSnapshot) {
            ...
            return StreamBuilder<List<QueryDocumentSnapshot<Map<String, dynamic>>>>(
              ...
              builder: (context, momentSnapshot) {
                ...
                final quests = [
                  (icon: '🐾', title: '오늘의 강아지 돌봄', done: cared),
                  (icon: '✍️', title: '오늘의 감정 한 줄 기록', done: postedToday),
                  (icon: '💬', title: '가족 일기에 반응 남기기', done: reacted),
                ];
                ...
                return Column(
                  ...
                  children: [
                    ...
                    for (final quest in quests) ...[
                      DailyQuest(icon: quest.icon, title: quest.title, done: quest.done),
                      const SizedBox(height: 8),
                    ],
                  ],
                );
